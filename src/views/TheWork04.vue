    ...
    <header>
      <div class="nav-inner">
        <ul>
          ...
          <li class="mobile">non</li>
        </ul>
      </div>
    </header>

    <div class="fixed-link-btn web">
      <router-link class="prev-link-btn" to="/works-Samhwa">PREV</router-link>
    </div>
      ...
      <div class="works-banner-inner">
        <div class="project-title-wrap">
          ...
          <div class="banner-link-btn">
            <a
              href="https://github.com/rlaekgp94/clone-laftel-v2"
              target="_blank"
              >Github</a
            >
            <a href="https://clone-laftel.netlify.app" target="_blank">Demo</a>
          </div>
        </div>
